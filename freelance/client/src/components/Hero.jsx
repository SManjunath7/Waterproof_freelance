        ...
        <div className="hero-content container">
          <div className="hero-text">
            <div className="hero-tagline">
              ...
              Bangalore's Trusted Experts Since 2010
            </div>
          ...
          <div className="hero-visual">
            <div className="hero-shield">
              ...
              <svg className="shield-svg" viewBox="0 0 340 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M170 20 L310 80 L310 220 Q310 330 170 380 Q30 330 30 220 L30 80 Z" fill="url(#shieldGrad)" stroke="rgba(100,160,255,0.4)" strokeWidth="2" />
                ...
                <circle cx="230" cy="120" r="26" fill="#22c55e" opacity="0.9" filter="url(#shieldGlow)" />
